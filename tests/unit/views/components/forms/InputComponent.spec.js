...
describe('InputComponent', () => {
  ...
  it('renders a label when provided one via props', () => {
    const wrapper = shallowMount(InputComponent, { localVue, provide, propsData: { ...propsData, label: 'test' } });
  ...
  it('passes a placeholder when to the input when provided one via props', () => {
    const wrapper = shallowMount(InputComponent, { localVue, provide, propsData: { ...propsData, placeholder: 'test' } });
